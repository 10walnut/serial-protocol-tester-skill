...
Turn a user's serial communication document, table, sample frames, or written description into an executable protocol script. The separate PySide6 application is an optional runtime for interactive testing.
